# npm-package-types Specification

## Purpose
Defines the requirements for `@ts2v/types` to be publishable to the npm registry and usable by projects that install it as a dependency.
