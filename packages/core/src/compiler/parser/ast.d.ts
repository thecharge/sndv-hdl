...
export type StatementNode = VariableDeclarationNode | ReturnStatementNode | IfStatementNode | ExpressionStatementNode;
...
export type ExpressionNode = AssignmentExpressionNode | BinaryExpressionNode | UnaryExpressionNode | IdentifierNode | NumberLiteralNode | HexLiteralNode | BinaryLiteralNode | BooleanLiteralNode | ArrayLiteralNode | ArrayAccessNode | SliceAccessNode;
