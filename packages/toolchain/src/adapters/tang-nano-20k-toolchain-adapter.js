...
exports.TangNano20kToolchainAdapter = void 0;
const node_path_1 = require("node:path");
class TangNano20kToolchainAdapter {
    processRunner;
    ...
    async synthesize(request) {
        ...
        const shellCommand = [
            'set -e',
            `${yosysExecutable} -p \"read_verilog -sv ${containerOutputDirectoryPath}/${sourceBaseName}.sv; synth_gowin -family gw2a -top ${topModuleName} -json ${containerOutputDirectoryPath}/${sourceBaseName}.json\"`,
...
exports.TangNano20kToolchainAdapter = TangNano20kToolchainAdapter;
//# sourceMappingURL=tang-nano-20k-toolchain-adapter.js.map